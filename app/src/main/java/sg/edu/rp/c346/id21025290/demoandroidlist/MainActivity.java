package sg.edu.rp.c346.id21025290.demoandroidlist;
...
//        aaVersions = new ArrayAdapter<AndroidVersion>(this, android.R.layout.simple_list_item_1, alAndroidVersions);
